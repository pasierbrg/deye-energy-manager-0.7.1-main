...
- osobny profil **Ustawienia ładowania** jest szablonem kopiowanym przy wyborze trybu `Charge`: prąd ładowania, prąd rozładowania, prąd ładowania z sieci, zgoda na ładowanie z sieci i docelowy SOC; późniejsze zmiany konkretnego slotu pozostają niezależne;
