    ...
    this.innerHTML = `
      <ha-card class="theme-schedule-dark">
        <style>
          ...
          .dem-v075{padding:18px;display:grid;gap:16px;font-family:Roboto,Arial,sans-serif;font-size:14px}
